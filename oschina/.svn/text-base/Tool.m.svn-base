...
//    defaultStyle.font = [UIFont fontWithName:@"arial" size:14.0f];
    defaultStyle.font = [UIFont boldSystemFontOfSize:14.0];
...
//	[result addObject:boldStyle];
    ...
    [coloredStyle setName:@"color"];
    coloredStyle.font = [UIFont fontWithName:@"arial" size:14.0f];
    [coloredStyle setColor:[UIColor colorWithRed:13.0/255.0 green:109.0/255.0 blue:168.0/255.0 alpha:1.0]];
	[result addObject:coloredStyle];
    
    FTCoreTextStyle *lightStyle = [defaultStyle copy];
    [lightStyle setName:@"light"];
    lightStyle.font = [UIFont fontWithName:@"arial" size:14.0f];
    [lightStyle setColor:[UIColor lightGrayColor]];
    [result addObject:lightStyle];
    
    FTCoreTextStyle *replyStyle = [defaultStyle copy];
    [replyStyle setName:@"reply"];
    [replyStyle setColor:[UIColor colorWithRed:255.0/255 green:70.0/255 blue:0.0 alpha:1.0]];
    replyStyle.font = [UIFont fontWithName:@"Helvetica-BoldOblique" size:13.0f];
//    replyStyle.font = [UIFont boldSystemFontOfSize:13.0];
//    replyStyle.font = [UIFont]
    [result addObject:replyStyle];
    
    FTCoreTextStyle *smallLightStyle = [lightStyle copy];
    [smallLightStyle setName:@"small"];
//    smallLightStyle.font = [UIFont fontWithName:@"arial" size:14.0f];
    smallLightStyle.font =  [UIFont fontWithName:@"arial" size:12.0];
    smallLightStyle.minLineHeight = 14;
    [result addObject:smallLightStyle];
